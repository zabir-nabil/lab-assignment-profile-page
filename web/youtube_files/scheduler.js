...
function C(){var a=g("yt.scheduler.instance.instance_");a&&(a&&"function"==typeof a.dispose&&a.dispose(),n("yt.scheduler.instance.instance_",null))}
function G(){y(B())}
...
function V(){window.clearTimeout(M);var a=B();a.f=0;a.start()}
;g("yt.scheduler.initialized")||(n("yt.scheduler.instance.dispose",C),n("yt.scheduler.instance.addJob",I),n("yt.scheduler.instance.addImmediateJob",J),n("yt.scheduler.instance.cancelJob",K),n("yt.scheduler.instance.cancelAllJobs",G),n("yt.scheduler.instance.start",Q),n("yt.scheduler.instance.pause",R),n("yt.scheduler.instance.setPriorityThreshold",T),n("yt.scheduler.instance.enablePriorityThreshold",U),n("yt.scheduler.instance.clearPriorityThreshold",V),n("yt.scheduler.initialized",!0));}).call(this);
